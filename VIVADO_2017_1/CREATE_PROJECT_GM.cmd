...
REM VIVADO VERSION
set /p Version=Vivado Version 2017.? :
setlocal enableextensions disabledelayedexpansion
...
@set VIVADO_XSETTINGS=%XILDIR%\%VIVADO_VERSION%\.settings64-Vivado.bat
...
:before_uinput
REM OVERRIDE
set /p creatProject="OVERRIDE THE CURRENT FOLDER "%VAR_UPDATE_VALUE%" ? (y/N):"
...
call vivado -source ../scripts/main.tcl  -mode batch -notrace -tclargs --run 1 --gui 1 --clean 2 --boardpart %PARTNUMBER%
