...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: PUSH_BUTTONS_POSITION, and set properties
  set PUSH_BUTTONS_POSITION [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 PUSH_BUTTONS_POSITION ]
  set_property -dict [ list \
CONFIG.C_ALL_INPUTS {1} \
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: Sine, and set properties
  set Sine [ create_bd_cell -type ip -vlnv xilinx.com:user:Sine:2.0 Sine ]
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net PUSH_BUTTONS_POSITION_GPIO [get_bd_intf_ports btns_5bits] [get_bd_intf_pins PUSH_BUTTONS_POSITION/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins DIP_SWITCHES_8BITS/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins LEDS_8BITS/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PUSH_BUTTONS_POSITION/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins Sine/ctrl_saxi] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DIP_SWITCHES_8BITS/s_axi_aclk] [get_bd_pins LEDS_8BITS/s_axi_aclk] [get_bd_pins PUSH_BUTTONS_POSITION/s_axi_aclk] [get_bd_pins Sine/ctrl_saxi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn1 [get_bd_pins DIP_SWITCHES_8BITS/s_axi_aresetn] [get_bd_pins LEDS_8BITS/s_axi_aresetn] [get_bd_pins PUSH_BUTTONS_POSITION/s_axi_aresetn] [get_bd_pins Sine/ctrl_saxi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DIP_SWITCHES_8BITS/S_AXI/Reg] SEG_DIP_SWITCHES_8BITS_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LEDS_8BITS/S_AXI/Reg] SEG_LEDS_8BITS_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PUSH_BUTTONS_POSITION/S_AXI/Reg] SEG_PUSH_BUTTONS_POSITION_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Sine/ctrl_saxi/ctrl_saxi_reg] SEG_Sine_ctrl_saxi_reg
...
preplace port sws_8bits -pg 1 -y 730 -defaultsOSRD
preplace port leds_8bits -pg 1 -y 370 -defaultsOSRD
preplace port btns_5bits -pg 1 -y 610 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 380 -defaultsOSRD
preplace inst Sine -pg 1 -lvl 2 -y 560 -defaultsOSRD
preplace inst PUSH_BUTTONS_POSITION -pg 1 -lvl 2 -y 700 -defaultsOSRD
preplace inst DIP_SWITCHES_8BITS -pg 1 -lvl 2 -y 840 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y 470 -defaultsOSRD
preplace inst LEDS_8BITS -pg 1 -lvl 2 -y 370 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 3 NJ 30 NJ 30 1170J
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 3 390 770 NJ 770 1100
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 830
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 3 20 290 NJ 290 780
preplace netloc ps7_0_axi_periph_M03_AXI 1 1 3 390 630 800J 650 1090
preplace netloc DIP_SWITCHES_8BITS_GPIO 1 2 3 NJ 840 NJ 840 1170
preplace netloc LEDS_8BITS_GPIO 1 2 3 790J 270 NJ 270 1170
preplace netloc PUSH_BUTTONS_POSITION_GPIO 1 2 3 NJ 700 NJ 700 1170
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 3 390 300 800J 290 1090
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 2 350J 440 820
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 50 NJ 50 1170J
preplace netloc rst_ps7_0_50M_peripheral_aresetn1 1 1 2 370 470 830
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 490 360 490 810
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 3 380 280 NJ 280 1100
levelinfo -pg 1 0 190 590 960 1150 1190 -top -10 -bot 910
",
}
