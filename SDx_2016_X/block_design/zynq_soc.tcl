...
CONFIG.c_sg_length_width {23} \
  ...
  # Create instance: madd_1, and set properties
  set madd_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:madd:1.0 madd_1 ]

  # Create instance: madd_1_if, and set properties
...
CONFIG.C_OUTPUT_FIFO_0_WIDTH {32} \
  ...
  # Create instance: mmult_1_if, and set properties
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net axi_ic_ps7_M_AXI_GP0_M01_AXI [get_bd_intf_pins axi_ic_ps7_M_AXI_GP0/M01_AXI] [get_bd_intf_pins mmult_1_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_ps7_M_AXI_GP0_M05_AXI [get_bd_intf_pins axi_ic_ps7_M_AXI_GP0/M05_AXI] [get_bd_intf_pins dm_3/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXIS_MM2S [get_bd_intf_pins dm_0/M_AXIS_MM2S] [get_bd_intf_pins madd_1_if/S_AXIS_FIFO_1]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXIS_MM2S [get_bd_intf_pins dm_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_1_if/S_AXIS_FIFO_0]
  ...
  connect_bd_intf_net -intf_net dm_2_M_AXIS_MM2S [get_bd_intf_pins dm_2/M_AXIS_MM2S] [get_bd_intf_pins mmult_1_if/S_AXIS_FIFO_1]
  ...
  connect_bd_intf_net -intf_net madd_1_A [get_bd_intf_pins madd_1/A] [get_bd_intf_pins madd_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net madd_1_B [get_bd_intf_pins madd_1/B] [get_bd_intf_pins madd_1_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net madd_1_C [get_bd_intf_pins madd_1/C] [get_bd_intf_pins madd_1_if/AP_FIFO_OARG_0]
  connect_bd_intf_net -intf_net madd_1_if_M_AXIS_FIFO_0 [get_bd_intf_pins dm_3/S_AXIS_S2MM] [get_bd_intf_pins madd_1_if/M_AXIS_FIFO_0]
  connect_bd_intf_net -intf_net madd_1_if_ap_ctrl [get_bd_intf_pins madd_1/ap_ctrl] [get_bd_intf_pins madd_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net mmult_1_A [get_bd_intf_pins mmult_1/A] [get_bd_intf_pins mmult_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net mmult_1_B [get_bd_intf_pins mmult_1/B] [get_bd_intf_pins mmult_1_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net mmult_1_C [get_bd_intf_pins mmult_1/C] [get_bd_intf_pins mmult_1_if/AP_FIFO_OARG_0]
  connect_bd_intf_net -intf_net mmult_1_if_M_AXIS_FIFO_0 [get_bd_intf_pins madd_1_if/S_AXIS_FIFO_0] [get_bd_intf_pins mmult_1_if/M_AXIS_FIFO_0]
  connect_bd_intf_net -intf_net mmult_1_if_ap_ctrl [get_bd_intf_pins mmult_1/ap_ctrl] [get_bd_intf_pins mmult_1_if/ap_ctrl]
  ...
  connect_bd_net -net clkid1 [get_bd_pins axi_ic_ps7_M_AXI_GP0/ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M04_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M05_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_ACLK] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_mm2s_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins dm_2/m_axi_mm2s_aclk] [get_bd_pins dm_2/s_axi_lite_aclk] [get_bd_pins dm_3/m_axi_s2mm_aclk] [get_bd_pins dm_3/s_axi_lite_aclk] [get_bd_pins madd_1/ap_clk] [get_bd_pins madd_1_if/aclk] [get_bd_pins madd_1_if/s_axi_aclk] [get_bd_pins mmult_1/ap_clk] [get_bd_pins mmult_1_if/aclk] [get_bd_pins mmult_1_if/s_axi_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  connect_bd_net -net madd_1_if_aresetn [get_bd_pins madd_1/ap_rst_n] [get_bd_pins madd_1_if/aresetn]
  connect_bd_net -net mmult_1_if_aresetn [get_bd_pins mmult_1/ap_rst_n] [get_bd_pins mmult_1_if/aresetn]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps7_M_AXI_GP0/ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_ic_ps7_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M05_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_ARESETN] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins dm_3/axi_resetn] [get_bd_pins madd_1_if/resetn] [get_bd_pins madd_1_if/s_axi_aresetn] [get_bd_pins mmult_1_if/resetn] [get_bd_pins mmult_1_if/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs mmult_1_if/S_AXI/reg0] SEG_mmult_1_if_reg0
